...
DELETE FROM TEST_CATEGORY WHERE CA_UID =27;

-- depth2 이면서 부모 uid 가 1인 카테고리 읽기 ORDER 오름차순 순으ㅡ로

SELECT * FROM TEST_CATEGORY WHERE CA_DEPTh =1and CA_PARENT =0ORDER BY CA_ORDER ASC ; 
SELECT * FROM TEST_CATEGORY WHERE CA_DEPTh =1ORDER BY CA_ORDER ASC ; 