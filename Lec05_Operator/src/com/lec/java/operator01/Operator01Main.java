...
public class Operator01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("나눈 나머지 : "+result);//결과값 int형
		...
		System.out.println("나머지연산 결과 : "+result3);
		...
		int num5;
		int num6;
//		System.out.println("num5 : "+num5); 에러 : 초기화 x
		System.out.println("num5 : "+(num5=100)); 
		
		num6 = num5 = 300; //요런 연산이 가능해요~""
		// 대입연산자는 우측에서부터 연산한다. num5 = 300 다음 num6 = 300 (num5) 수행 
		//ex)num6 = 100+200+300;
