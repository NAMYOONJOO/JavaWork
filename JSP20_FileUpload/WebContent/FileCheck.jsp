...
<%for(int i = 0; i <originalFileNames.length; i++){ %>
<form action="FileDownload.jsp" name="frm<%=i %>">
...
<img style="width:100%; height:auto"
      src="upload/<%=fileSystemNames[i]%>"/> </div>
 <%} %>
</body>
</html>
