...
public class Anonymous02Main {
	...
	public static void main(String[] args) {
		...
		double result = tc1.opperate(1, 2);
		...
		Calculable tc2 = new Calculable() {
			...
			@Override
			public double opperate(double x, double y) {
				return Math.pow(x, y);
			}
		};
		System.out.println(tc2.opperate(2, 4));
...
interface Calculable{
	public abstract double opperate(double x, double y);
